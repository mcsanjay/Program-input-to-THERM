Auto_THERM - a program that calculates all the information needed to find thermodynamic properties of a chemical species using THERM software.
...
3. Running the program for a single species using SMILES. Type :
	./Auto_THERM.py -s "<SMILES_of_the_species>" "<Name_of_the_species>"

   Running the program for a single species using molfile. Type :
	./Auto_THERM.py -mf <Path_to_Molfile> "<Name_of_the_species>"
